...
<header>
	...
	div.pub{width: 90%; max-width: 400px; min-height: 70px; max-height: 1000px; display: block; margin: auto; border: none; border-radius: 5px; background-color: #FFF; box-shadow: 0 0 6px #A1A1A1; margin-top: 30px; text-align: center;}
	...
	div.not{width: 90%; max-width: 400px; height: 70px; display: block; margin: auto; border: none; border-radius: 5px; background-color: #FFF; box-shadow: 0 0 6px #A1A1A1; text-align: center;}
	div.not a{color: #666; text-decoration: none; position: relative; top: 25%; width: 100%; padding-left: 10px; padding-right: 10px;}
			...
			while ($not=mysql_fetch_assoc($notificacoes)) {
				...
				if ($not['tipo']=="1") {
					echo '<br /><div class="not" id="'.$id.'">
						<a href="myprofile.php?id='.$not['post'].'">'.$nome.' gostou de uma publicação tua</a>
					</div>';
				}elseif($not['tipo']=="2"){
					echo '<br /><div class="not" id="'.$id.'">
